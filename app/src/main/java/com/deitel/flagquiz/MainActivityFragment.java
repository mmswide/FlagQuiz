...
//         getString(R.string.question, 1, FLAGS_IN_QUIZ));
   ...
   public void updateQuizCounts(SharedPreferences sharedPreferences) {
      String sizes = sharedPreferences.getString(MainActivity.SIZES, null);
      flags_in_quiz = Integer.parseInt(sizes);
   }
